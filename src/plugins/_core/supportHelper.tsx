...
async function generateDebugInfoMessage() {
    ...
    const info = {
        "Vencord+":
            `v${VERSION} • [${gitHash}](<https://github.com/childoftherion/VencordPlus/commit/${gitHash}>)` +
            ...
            if (!IS_WEB && IS_UPDATER_DISABLED) {
                return Alerts.show({
                    ...
                    body: <div>
                        ...
                        <Forms.FormText className={Margins.top8}>
                            If you are experiencing issues, please contact your <Link href="https://github.com/childoftherion/VencordPlus">package maintainer</Link> for support instead.
                        </Forms.FormText>
                    </div>,
                    onCloseCallback: () => { }
                });
