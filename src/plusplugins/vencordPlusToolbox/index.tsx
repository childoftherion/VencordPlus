        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "VencordPlus Toolbox"}
...
export default definePlugin({
    name: "VencordPlusToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses VencordPlus quick actions",
