...
import { Devs, SuncordDevs, EquicordDevs } from "@utils/constants";
import definePlugin from "@utils/types";
import type { Guild } from "@vencord/discord-types";
import { EmojiStore, Menu, StickersStore as StickerStore } from "@webpack/common";
...
export default definePlugin({
    ...
    description: "Adds a context menu option to dump and download a server's assets (emojis and stickers)",
    authors: [
        SuncordDevs.Cortex,
        Devs.Samwich,
        EquicordDevs.Synth,
