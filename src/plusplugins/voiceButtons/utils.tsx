...
import { findComponentByCodeLazy, findLazy, findStoreLazy } from "@webpack";
import { Button, ChannelStore, NavigationRouter, Tooltip, UserStore } from "@webpack/common";
import { JSX } from "react";

import { settings } from "./settings";

const MediaEngineStore = findStoreLazy("MediaEngineStore");
const VoiceActions = findLazy(m => m.toggleSelfMute && m.toggleLocalMute);
