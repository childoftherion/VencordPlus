...
function SettingsComponent(props: { setValue(v: any): void; }) {
    ...
    return (
        <Flex flexDirection="column">
            ...
            <Forms.FormDivider />
            <Forms.FormSection title="File Upload Size Limit Circumvention">
                <Forms.FormText type={Forms.FormText.Types.DESCRIPTION}>
                    Select the external file uploader service to be used to circumvent the file upload size limit.
                </Forms.FormText>
                <Select
                    options={[
            ...
            <Forms.FormSection>
                <Switch
                    ...
                    note="Whether to automatically send the links of the uploaded files to chat instead of pasting them into the chatbox."
                    hideBorder={true}
                >
...
export default definePlugin({
    name: "BigFileUpload",
    description: "Circumvent Discord's file upload size limit by uploading files to an external service",
    authors: [{ name: "ScattrdBlade", id: 678007540608532491n }],
    settings,
