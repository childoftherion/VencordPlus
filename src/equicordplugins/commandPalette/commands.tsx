...
export const actions: ButtonAction[] = [
    { id: "openVencordSettings", label: "Open Vencord tab", callback: async () => await SettingsRouter.open("VencordSettings"), registrar: "VencordPlus" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.open("VencordPlugins"), registrar: "VencordPlus" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.open("VencordThemes"), registrar: "VencordPlus" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.open("VencordUpdater"), registrar: "VencordPlus" },
    { id: "openCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.open("VencordCloud"), registrar: "VencordPlus" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.open("VencordSettingsSync"), registrar: "VencordPlus" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "VencordPlus" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "VencordPlus" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "VencordPlus" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "VencordPlus" },
